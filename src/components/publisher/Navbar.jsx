...
const Navbar = () => {
  ...
  return (
    <div id="navbar">
      <div className="card" onClick={()=>navigate('/publisher_alert')}>
        <div>
      ...
      <div className="card" onClick={()=>navigate('/publisher_inventory')}>
        <div>
      ...
      <div className="card" onClick={()=>navigate('/publisher_summary')}>
        <div>
